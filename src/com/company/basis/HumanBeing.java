...
public class HumanBeing implements Comparable<com.company.basis.HumanBeing>, Serializable {
    ...
    public int compareTo(com.company.basis.HumanBeing anotherHuman) {
        if (this.coordinates.getX() == anotherHuman.coordinates.getX()) {
            return 0;
        } else if (this.coordinates.getX() > anotherHuman.coordinates.getX()) {
            return 1;
        } else {
            return -1;
        }
